...
class Kesiswaan extends CI_Controller {
    ...
    public $table       = 'fkesiswaan';
    public $judul       = 'Kesiswaan';
    public $aktifgrup   = 'kesiswaan';
    public $aktifmenu   = 'kesiswaan';
    public $foldername  = 'kesiswaan';
    public $indexpage   = 'kesiswaan/v_kesiswaan';
