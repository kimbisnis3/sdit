          ...
          <form id="form-data">
            <div class="row">
              ...
              <!--
                ...
                <div class="form-group">
                <label>Menu</label>
                  <select class="form-control" name="judultopic" id="judultopic">
                  <option value="">--</option>
...
?> 
    ...
    $(document).ready(function(){
            $("#judultopic").change(function (){
                var url = "<?php echo site_url('Slideshow/loadtopic');?>/"+$(this).val();
                $('#topic').load(url);
                return false;
            })
            });
    ...
    var judultopic = $('[name="judultopic"]').val();
    var topic = $('[name="topic"]').val();
    if (judultopic == '') {
    $('[name="judultopic"]').focus();
    showNotif('Perhatian' ,'Data Harap Dilengkapi', 'danger');
    $('[name="judultopic"]').css({'border-color' : '#ebccd1'});
    return false;}

    if (topic == '') {
    $('[name="topic"]').focus();
    showNotif('Perhatian' ,'Data Harap Dilengkapi', 'danger');
    $('[name="topic"]').css({'border-color' : '#ebccd1'});
    return false;}
